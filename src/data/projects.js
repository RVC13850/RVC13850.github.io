export const projects = [
    ...
    {
      title: "BlackHole",
      description: "A React-based application for managing and tracking degree progress, featuring course management and degree planning capabilities.",
      tech: ["Python", "Flask", "JavaScript", "React", "Node.js"],
